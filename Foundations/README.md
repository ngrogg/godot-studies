...
How to install GoDot and a rundown of GoDot's interface. <br>
...
## Book Information
Name: Godot from Zero to Proficiency (Foundations) <br>
Author: Patrick Felicia <br>
Cover: <br>
![Book Cover](../images/Foundations.jpg)
